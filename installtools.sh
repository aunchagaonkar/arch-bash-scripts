...
yay -S archlinux-tweak-tool-git arcolinux-app-glade-git microsoft-edge-stable-bin oneko peazip-qt-bin update-grub cloudflare-warp-bin #Install essential tools
